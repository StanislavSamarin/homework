...
// Получили от пользователя значения k1, b1, k2, b2
...
// Провели проверку на наличие точки пересечения прямых
...
// Нашли координаты точки пересечения прямых
...
// Показали координаты точки пересечния прямых